-- Corrigir view para manter compatibilidade de tipos
-- Primeiro, dropar a view existente
DROP VIEW IF EXISTS public.vw_dashboard_metricas;

-- Recriar a view com tipos corretos
...
SELECT 
  ...
  COALESCE(mv.meta_valor::numeric, 0) as meta_mes, -- Converter bigint para numeric
  CASE 
