      ...
      >
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="mb-2.5">
                <div className="text-xl sm:text-2xl font-bold text-green-600 truncate">
                  {formatCurrency(rota.saldoMeta, true)}
                </div>
                <div className="text-gray-600 text-[10px] sm:text-xs">Saldo</div>
                <div className="text-gray-500 text-[10px] sm:text-xs truncate">Meta: {formatCurrency(rota.metaAnoAtual, true)}</div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-2 text-center">
                ...
                <div className="flex flex-col items-center">
                  <div className="flex items-center gap-0.5">
                    ...
                    <span className="font-bold text-xs sm:text-sm text-red-600">{rota.semVendas120d}</span>
                  </div>
        ...
        <div className="bg-orange-50 py-2.5 px-4 flex items-center gap-2">
          ...
          <span className="text-orange-700 font-semibold text-xs sm:text-sm truncate">
            Oportunidade de Venda: {formatCurrency(rota.somaOportunidades, true)}
          </span>
        </div>
      </Card>
    )
