...
import { BarChart3, Users, DollarSign, Target, Calendar, RefreshCw, Menu, X, Home, MapPin, TrendingUp, GitBranch, CalendarDays } from 'lucide-react'
          ...
          <div className="relative flex items-center justify-between h-14">
            <div className="absolute inset-y-0 left-0 flex items-center md:hidden">
              <button
                ...
                className="inline-flex items-center justify-center p-2 rounded-md text-gray-500 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary"
              >
            ...
            <div className="flex-1 flex items-center justify-center md:items-stretch md:justify-start">
              <div className="hidden md:block">
                <div className="flex space-x-4">
                  ...
                  <NavLink to="/gestao/agenda" className={({ isActive }) => `flex items-center px-3 py-2 rounded-md text-sm font-medium ${ isActive ? 'bg-primary/10 text-primary' : 'text-gray-500 hover:bg-gray-100 hover:text-gray-700' }`}><CalendarDays className="h-5 w-5 mr-2" />Agenda</NavLink>
                </div>
              </div>
            </div>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              ...
              <NavLink to="/gestao/agenda" onClick={() => setIsMenuOpen(false)} className={({ isActive }) => `flex items-center px-3 py-2 rounded-md text-base font-medium ${ isActive ? 'bg-primary/10 text-primary' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900' }`}><CalendarDays className="h-5 w-5 mr-2" />Agenda</NavLink>
            </div>
          </div>
        )}
      </nav>
        ...
        {location.pathname === '/gestao' ? (
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 sm:gap-6 mb-6 sm:mb-8">
                <Card variant="default" padding="none" className="p-4 sm:p-6"><div className="flex items-start justify-between"><div className="flex-1 min-w-0"><p className="text-xs sm:text-sm text-gray-600 mb-1">Vendas Totais</p><p className="text-base sm:text-xl font-bold text-gray-900 truncate">{formatCurrency(metricas.vendasTotais)}</p><p className="text-xs text-gray-500 mt-1">Meta: {formatCurrency(metricas.metaTotal || 0)}</p></div><DollarSign className="h-5 w-5 sm:h-6 sm:w-6 text-green-500" /></div></Card>
                <Card variant="default" padding="none" className="p-4 sm:p-6"><div className="flex items-start justify-between"><div className="flex-1 min-w-0"><p className="text-xs sm:text-sm text-gray-600 mb-1">Faturadas</p><p className="text-base sm:text-xl font-bold text-blue-900 truncate">{formatCurrency(metricas.vendasFaturadas)}</p><p className="text-xs text-gray-500 mt-1">Clientes: {metricas.clientesFaturados}</p></div><BarChart3 className="h-5 w-5 sm:h-6 sm:w-6 text-blue-500" /></div></Card>
                <Card variant="default" padding="none" className="p-4 sm:p-6"><div className="flex items-start justify-between"><div className="flex-1 min-w-0"><p className="text-xs sm:text-sm text-gray-600 mb-1">A Faturar</p><p className="text-base sm:text-xl font-bold text-orange-900 truncate">{formatCurrency(metricas.vendasAFaturar)}</p><p className="text-xs text-gray-500 mt-1">Clientes: {metricas.clientesAFaturar}</p></div><Calendar className="h-5 w-5 sm:h-6 sm:w-6 text-orange-500" /></div></Card>
